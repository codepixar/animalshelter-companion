    ...
    final class Animalshelter_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'animalshelter-map-custom', plugins_url( 'assets/js/map-custom.js', __FILE__ ), array('jquery'), '1.0', true );

            // animalshelter companion main js
            wp_enqueue_script( 'animalshelter-companion', plugins_url( 'assets/js/animalshelter-companion-main.js', __FILE__ ), array( 'jquery', 'jquery-ui-datepicker' ), '1.0', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'animalshelter-companion-elementor-edit', plugins_url( '/assets/css/elementor-edit.css', __FILE__ ) );
        }
