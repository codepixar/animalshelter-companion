...
function animalshelter_volunteer_scripts() {
    wp_enqueue_style( 'volunteer-style', plugins_url( '../css/booking.css', __FILE__ ), array(), '1.0', false );
    wp_enqueue_script( 'volunteer-script', plugins_url( '../js/booking.js', __FILE__ ), array('jquery'), '1.0', true );
}
