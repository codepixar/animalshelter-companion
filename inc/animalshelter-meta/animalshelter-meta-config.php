 ...
 */
    ...
    function animalshelter_meta_scripts() {
        wp_enqueue_style( 'animalshelter-meta-style', plugins_url( 'assets/css/animalshelter-meta.css', __FILE__ ) );
        wp_enqueue_script( 'animalshelter-meta-script', plugins_url( 'assets/js/animalshelter-meta.js', __FILE__ ), array('jquery'), '1.0', true );
    }
